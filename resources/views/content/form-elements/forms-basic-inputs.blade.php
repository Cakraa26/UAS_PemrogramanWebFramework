    ...
    <div class="col-md-6">
      <div class="card">
        ...
        <div class="card-body demo-vertical-spacing demo-only-element">
          ...
          <div class="form-floating form-floating-outline mb-6">
            <select multiple="multiple" class="form-select h-100" id="exampleFormControlSelect2"
          ...
          <div class="mb-6">
            <label for="exampleFormControlSelect3" class="form-label">An example of a multi-select option is the 'size'
              attribute</label>
          ...
          <div class="form-floating form-floating-outline">
            <input type="text" readonly="readonly" class="form-control-plaintext px-0"
      ...
      <div class="card mb-6">
        ...
        <div class="row row-bordered g-0">
          <div class="col-md p-6">
            ...
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="" id="disabledCheck2" disabled="disabled"
                checked="checked" />
          ...
          <div class="col-md p-6">
            ...
            <div class="form-check">
              <input class="form-check-input" type="radio" value="" id="disabledRadio2" disabled="disabled"
                checked="checked" />
        ...
        <div class="row row-bordered g-0">
          <div class="col-xxl-6 col-xl-12 col-md-6">
            ...
            <div class="card-body">
              ...
              <div class="form-check form-switch">
                <input class="form-check-input" type="checkbox" id="flexSwitchCheckCheckedDisabled" checked="checked"
                  disabled="disabled" />
          ...
          <div class="col-xxl-6 col-xl-12 col-md-6">
            ...
            <div class="card-body">
              ...
              <div class="form-check form-check-reverse">
                <input name="reverse-radio-1" class="form-check-input" type="radio" value=""
                  id="reverseRadio2" checked="checked" />
    ...
    <div class="col-xl-6">
      ...
      <div class="card mb-6">
        ...
        <div class="card-body">
          ...
          <div class="form-floating form-floating-outline mb-6">
            <input class="form-control" type="color" id="html5-color-input" value="#04364A"
